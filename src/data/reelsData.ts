...
export const REELS_DATA: ReelItem[] = [
  // ==========================================
  // 1. TOP YO YO HONEY SINGH VIRAL REELS (हनी सिंह के वायरल रील्स)
  // ==========================================
  {
    id: 'reel-yoyo-1',
    ...
    caption: 'Yo Yo Honey Singh is back with Millionaire! 👑🔥 Full bass drop vibe on Instagrand! Tag your squad! #Millionaire #YoYoHoneySingh #Glory #InstaViral #ReelsKing',
    audioTrackTitle: 'Millionaire (Glory Album Hit)',
    audioTrackArtist: 'Yo Yo Honey Singh',
    audioTrackUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3',
    audioTrackCover: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600&auto=format&fit=crop&q=80',
    category: 'hindi',
    likesCount: 384500,
    isLiked: true,
    commentsCount: 8940,
    ...
    tags: ['#Millionaire', '#YoYoHoneySingh', '#ReelsIndia', '#Glory'],
    comments: [
      {
        id: 'cy1',
        ...
        text: 'Bhai Honey Singh ka swag koi beat nahi kar sakta! 🔥👑',
        timestamp: '10m ago',
        likes: 310,
        isVerified: true,
      },
      {
        ...
        text: 'Smooth video and crisp bass! On loop forever 💜✨',
        timestamp: '25m ago',
        likes: 195,
        isVerified: true,
      },
  ...
  },
  {
    ...
    posterUrl: 'https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=600&auto=format&fit=crop&q=80',
    caption: 'Kudiye ni tere brown rang ne! 🕶️✨ OG Swag from Honey Singh that never gets old! #BrownRang #HoneySingh #RetroSwag #DesiKalakaar',
    audioTrackTitle: 'Brown Rang (Desi Kalakaar Retro Mix)',
    audioTrackArtist: 'Yo Yo Honey Singh',
    audioTrackUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3',
    audioTrackCover: 'https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=600&auto=format&fit=crop&q=80',
    category: 'hindi',
    likesCount: 295000,
    isLiked: false,
    commentsCount: 6420,
    ...
    tags: ['#BrownRang', '#HoneySingh', '#OGBeat', '#DanceReel'],
    comments: [
      {
        id: 'cy3',
  ...
  },
  {
    ...
    caption: 'Blue Eyes Hypnotize Teri Kardi Ae Mainu! 💙⚡ Club party vibes only! #BlueEyes #YoYoHoneySingh #ClubAnthem #InstagrandViral',
    audioTrackTitle: 'Blue Eyes (Hypnotize Club Bass)',
    audioTrackArtist: 'Yo Yo Honey Singh',
    audioTrackUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3',
    ...
    sharesCount: 33400,
    viewsCount: 890000,
    adMobEarnings: '+$0.70 AdMob',
    tags: ['#BlueEyes', '#HoneySingh', '#PartyVibes', '#ReelsKing'],
    comments: [],
  },
  // ==========================================
  // 2. POPULAR HINDI REELS (VIRAL BOLLYWOOD & DANCE)
  // ==========================================
  {
    id: 'reel-h1',
    authorId: 'usr-rohan',
